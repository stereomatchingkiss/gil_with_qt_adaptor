...
class format_table
{
  public :
    format_table();
    std::map<int, QString> &get_bit_aligned_table() { return bit_aligned_table; }
    std::map<int, QString> &get_packed_aligned_table() { return packed_aligned_table; }
    std::map<int, QString> const &get_bit_aligned_table() const { return bit_aligned_table; }
    std::map<int, QString> const &get_packed_aligned_table() const { return packed_aligned_table; }
